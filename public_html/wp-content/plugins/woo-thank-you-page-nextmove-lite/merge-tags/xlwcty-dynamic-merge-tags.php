...
//			),
	...
	public static function order_billing_country() {
		...
		return WC()->countries->get_formatted_address( array( 'country' => XLWCTY_Compatibility::get_billing_country_from_order( $order ) ) );
	}
	...
	public static function order_shipping_country() {
		...
		return WC()->countries->get_formatted_address( array( 'country' => XLWCTY_Compatibility::get_shipping_country_from_order( $order ) ) );
	}
	...
	public static function subscription_id() {
		...
		$subscriptions = wcs_get_subscriptions_for_order( XLWCTY_Compatibility::get_order_id( $order ), array( 'order_type' => 'any' ) );
