...
//		$this->notice_time['sales_trigger'] = $sales_trigger_notice_time;
	...
	public function notice_enqueue_scripts() {
		wp_enqueue_style( 'xl-notices-css', plugin_dir_url( $this->plugin_path ) . 'admin/assets/css/xlwcty-xl-notice.css', array(), XLWCTY_VERSION );
	...
	protected function nextmove_notice_html() {
		$nextmove_link = add_query_arg( array(
			...
			'utm_medium'   => 'notice',
			'utm_campaign' => 'nextmove-pro',
			'utm_term'     => 'get-info',
		), 'https://xlplugins.com/woocommerce-thank-you-page-nextmove/' );
		ob_start();
		?>
        <div class="updated" id="xl_notice_type_2" data-plugin="nextmove">
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn">
                        <a class="button" href="<?php echo $nextmove_link; ?>" data-name="XL WooCommerce Sales Triggers" target="_blank">Get More Info</a>
            ...
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn plugin-card plugin-card-<?php echo $plugin_slug; ?>">
                        <a class="install-now button" data-slug="<?php echo $plugin_slug; ?>" href="<?php echo $plugin_url; ?>" aria-label="Install WooCommerce Sales Countdown Timer – Finale Lite"
                           data-name="WooCommerce Sales Countdown Timer – Finale Lite">Try
                            for Free</a>
                        <p><a class="xl-notice-dismiss" data-mode="later" href="javascript:void(0)">May be
                                later</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="xl-notice-dismiss" data-mode="dismiss" title="Dismiss forever" href="javascript:void(0)">No, thanks</a></p>
                    </div>
	...
	protected function halloween_sale_notice_html() {
		$halloween_link = add_query_arg( array(
			'utm_source'   => 'nextmove-lite',
			'utm_medium'   => 'notice',
        ...
        <div class="updated" id="xl_notice_type_2" data-plugin="halloween_sale_18">
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn">
                        <a class="button" href="<?php echo $halloween_link; ?>" data-name="XL WooCommerce Sales Triggers" target="_blank">Grab The Offer</a>
                        <p><a class="xl-notice-dismiss" data-mode="later" href="javascript:void(0)">May be
                                later</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="xl-notice-dismiss" data-mode="dismiss" title="Dismiss forever" href="javascript:void(0)">No, thanks</a></p>
                    </div>
                </div>
                <div class="upsell_main_abs">
                    <h3>Upgrade to NEXTMOVE PRO and Save 20%! Use coupon 'XLHALLOWEENSALE18'</h3>
	...
	protected function pre_black_friday_notice_html() {
		$pre_black_friday_link = add_query_arg( array(
			'utm_source'   => 'nextmove-lite',
			'utm_medium'   => 'notice',
        ...
        <div class="updated" id="xl_notice_type_2" data-plugin="pre_black_friday_18">
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn">
                        <a class="button" href="<?php echo $pre_black_friday_link; ?>" data-name="NextMove: WooCommerce Thank You Page" target="_blank">Grab The Offer</a>
                        <p><a class="xl-notice-dismiss" data-mode="later" href="javascript:void(0)">May be
                                later</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="xl-notice-dismiss" data-mode="dismiss" title="Dismiss forever" href="javascript:void(0)">No, thanks</a></p>
                    </div>
                </div>
                <div class="upsell_main_abs">
                    <h3>Prepare your store for Black Friday Sale. Upgrade to NEXTMOVE PRO and Save 20%!</h3>
	...
	protected function bfcm_notice_html() {
        ...
        <div class="updated" id="xl_notice_type_2" data-plugin="bfcm_18">
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn">
                        <a class="button" href="<?php echo $bfcm_link; ?>" data-name="NextMove: WooCommerce Thank You Page" target="_blank">Grab The Offer</a>
                        <p><a class="xl-notice-dismiss" data-mode="later" href="javascript:void(0)">May be
                                later</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="xl-notice-dismiss" data-mode="dismiss" title="Dismiss forever" href="javascript:void(0)">No, thanks</a></p>
                    </div>
                </div>
                <div class="upsell_main_abs">
                    <h3>Upgrade to NEXTMOVE PRO and Save 30%! Use coupon 'XLBFCM18'</h3>
	...
	protected function christmas_notice_html() {
		$christmas_link = add_query_arg( array(
			'utm_source'   => 'nextmove-lite',
			'utm_medium'   => 'notice',
        ...
        <div class="updated" id="xl_notice_type_2" data-plugin="christmas_18">
            <div class="xl_upsell_area">
                ...
                <div class="upsell_right_abs">
                    <div id="plugin-filter" class="upsell_xl_plugin_btn">
                        <a class="button" href="<?php echo $christmas_link; ?>" data-name="NextMove: WooCommerce Thank You Page" target="_blank">Grab The Offer</a>
                        <p><a class="xl-notice-dismiss" data-mode="later" href="javascript:void(0)">May be
                                later</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="xl-notice-dismiss" data-mode="dismiss" title="Dismiss forever" href="javascript:void(0)">No, thanks</a></p>
                    </div>
                </div>
                <div class="upsell_main_abs">
                    <h3>Upgrade to NEXTMOVE PRO and Save 25%! Use coupon 'XLCHRISTMAS18'</h3>
	...
	public function set_xl_transient( $key, $value, $expiration ) {
		$array = array( 'time' => time() + (int) $expiration, 'value' => $value );
