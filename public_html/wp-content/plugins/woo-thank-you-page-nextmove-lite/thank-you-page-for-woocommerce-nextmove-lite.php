<?php
/**
 * Plugin Name: NextMove - WooCommerce Thank You Page Lite
 ...
 *
 * NextMove - WooCommerce Thank You Page Lite is free software.
 * You can redistribute it and/or modify it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * any later version.
 *
 * NextMove - WooCommerce Thank You Page Lite is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with NextMove - WooCommerce Thank You Page Lite. If not, see <http://www.gnu.org/licenses/>.
 *
 * @package NextMove
 * @Category Core
 * @author XLPlugins
...
if ( ! class_exists( 'XLWCTY_Core' ) ) :
	...
	class XLWCTY_Core {
		...
		public function define_plugin_properties() {
			/** Defining Constants */
			define( 'XLWCTY_VERSION', '2.8.0' );
			define( 'XLWCTY_MIN_WC_VERSION', '2.6' );
			define( 'XLWCTY_NAME', 'NextMove Lite' );
			define( 'XLWCTY_FULL_NAME', 'NextMove - WooCommerce Thank You Page Lite' );
		...
		public function xlwcty_init() {
			if ( xlwcty_is_woocommerce_active() && class_exists( 'WooCommerce' ) ) {
				...
				global $woocommerce;
				if ( ! version_compare( $woocommerce->version, XLWCTY_MIN_WC_VERSION, '>=' ) ) {
